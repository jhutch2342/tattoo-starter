            ...
            <div className="flex flex-col xl:flex-row gap-x-5 gap-y-16 xl:gap-y-0">
              {info.map((item, index) => {
                ...
                return (
                  ...
                  <div key={index}>
                    {/* title */}
                    <div className="font-primar uppercase font-medium text-xl mb-3">
                      {title}
                    </div>
                    {/* subtitle */}
                    <div className="m6-6 text-[#333] leading-[187%] tracking-[0.02em]">
                      {subtitle}
                    </div>
                    <div className="flex flex-col gap-y-3 mb-8">
                      ...
                      {/* email */}
                      <div classnName={'flex items-center gap-[10px]'}>
                        <div>{email.icon}</div>
